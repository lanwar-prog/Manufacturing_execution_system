<%-- 
    ...
    Created on : 02.04.2016, 13:15:26
 	...
 	<%@include file="HeadSapcon.jsp"%>
        ...
        <script>
            $(document).ready(function() {
                getData(0,"${pageContext.request.contextPath}/OperationContr","list");
                getData(1,"${pageContext.request.contextPath}/OperationContr","clear");
            });
        </script>
    </body>
</html>