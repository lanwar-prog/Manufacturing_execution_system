...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                 <%! String pgname = "Обновление остатков товаров";%>
        <title><%= pgname%></title>
            ...
            <tr valign="top">
                <td align="center" colspan="2">
                    <table align="center" style="margin: -20px;" class="table_1c">                 
                        <tr>
                            <th>Обновление остатков товаров на складах</th>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>                                    
                                <input style="float: right" type="button" value="Возврат" onClick="location.href='Rep1CArticleRest.jsp';">                          
                            </td>
                        </tr>
                    </table>
                </td>
